...
<f:view>
    <center>
        ...
        <a4j:form>
            ...
            <rich:panel>
                ...
                <h:panelGrid columns="2">
                    <h:outputLabel value="Nombre producto: "></h:outputLabel> <h:inputText
                        id="nombreProducto" value="#{productoRegistrar.nombre}" size="4"
                        required="true"
                    ...
                    <h:outputLabel value="Precio: "></h:outputLabel> <h:inputText
                        value="#{productoRegistrar.precio}"></h:inputText>
                    <h:outputLabel value="Existencia: "></h:outputLabel> <h:inputText
                        value="#{productoRegistrar.cantidad}"></h:inputText>

                    <a4j:commandButton value="Registrar"
                                       action="#{mantenimientoProductos.registrarProducto}"
                                       reRender="tablaProductos"/>
                </h:panelGrid>
            </rich:panel>
        </a4j:form>
        ...
        <rich:dataTable id="tablaProductos" value="#{mantenimientoProductos.listaProductos}"
                        var="productoLista">
